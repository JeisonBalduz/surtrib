        ...
        <div class="col-12">
          ...
          <div class="card" id="listadoregistros">
                     <div class="card-header">
                            <h3 class="card-title">Contribuyentes  <button class="btn btn-info" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Nuevo</button> </h3>
                       </div>
            <!-- /.card-header -->
			           <div class="card-header">
			              <div class="row">
						   ...
						   <button type="submit" onclick="listar()" class="btn btn-info">Mostrar</button>
				              <a href="http://localhost/surtri/vistas/contri.php" type="submit" class="btn btn-danger float-right">Limpiar</a>
...
require 'footer.php';
?>
        <script type="text/javascript" src="scripts/contri.js?ts=<?php echo date("Y-m-d H:i:s");?>"></script>
