...
$tramite = "SELECT u.rfc,u.name,u.rif,c.id,cc.id AS ccid,c.annomm,c.income,c.tax,c.deductible,cc.moment,cc.tramite,cc.rfc,a.detalles,a.codigo_grupo,a.minimo_tributable,a.alicuota FROM companyeib c LEFT JOIN companye cc ON c.idrelcompanye=cc.id LEFT JOIN activities a ON c.idactivity=a.id LEFT JOIN users u ON cc.rfc=u.usuario WHERE cc.id='$codigo' ORDER BY c.annomm DESC";
