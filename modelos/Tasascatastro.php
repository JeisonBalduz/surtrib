...
Class Tasascatastro
{
	...
	public function insertar($rfc,$vidc,$iduser,$unidad,$obs)
	{

		$sql="INSERT INTO `catastro`(`idtc`, `rfc`, `metros`, `obs`,`iduser`) VALUES ('$vidc','$rfc','$unidad','$obs','$iduser')";
	...
	{
		$sql="SELECT * FROM tributescatastro";
		return ejecutarConsulta($sql);		
	}
