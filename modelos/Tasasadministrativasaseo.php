...
Class Tasasadm
{
	...
	public function insertar($rfc,$vidt,$iduser,$obs)
	{

		$sql="CALL IncluirTasaAseo('$rfc','$vidt','$iduser','$obs')";
	...
	{
		$sql="SELECT * FROM tributes_aseo WHERE umtmin!=0 AND umtmin=umtmax";
		return ejecutarConsulta($sql);		
	}
