...
Class Tasasadm
{
	...
	public function insertar($rfc,$vidt,$iduser,$obs,$monto)
	{

		$sql="CALL IncluirTasaManualAseo('$rfc','$vidt','$iduser','$obs',$monto)";
	...
	{
		$sql="SELECT * FROM tributes_aseo WHERE umtmin!=0";
		return ejecutarConsulta($sql);		
	}
