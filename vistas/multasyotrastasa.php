...
<section class="content">
      <div class="container-fluid">
                  ...
                  <div class="col-12">
		            <div class="card" id="listadoregistros">
                              <div class="card-header">
                                    <h3 class="card-title">Trámite por Multas y Otras Tasas <!--  <button class="btn btn-info" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Nuevo</button>--> </h3>
                                    <a href="multasyotrastasa.php" type="submit" class="btn btn-danger float-right">Limpiar</a>
                              </div>
            ...
            <div class="card card-info" id="formularioregistros">  
                  <div class="card-header">
                        <h3 class="card-title">Formulario de Registro de Multas y Otras Tasas</h3>
                  </div>
			            ...
			            <div class="row">
                              ...
                              <div class="row">
                                    <div class="form-group col-sm-12 col-xs-12">
                                          <label>Tasa Administrativa</label>
                                                <select class="form-control" name="vidt" id="vidt" placeholder="Seleccione Categoría" required>
                                                </select>
                                    </div>
                              ...
                              <div class="row">
                                    <div class="form-group col-sm-6 col-xs-4">
                                          <label>Monto</label>
                                                <input type="text" name="monto" id="monto" data-name="monto" class="form-control" placeholder="Ingrese Monto" required>
                                    </div>
                                    <div class="form-group col-sm-6 col-xs-4">
                                          <label>Resolución</label>
                                                <input type="text" value="N/A" name="resolucion" id="resolucion" class="form-control" placeholder="Ingrese Resolución ">
                                    </div>
...
require 'footer.php';
?>
        <script type="text/javascript" src="scripts/multasyotrastasa.js?ts=<?php echo date("Y-m-d H:i:s");?>"></script>
