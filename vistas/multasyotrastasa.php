                  ...
                  <div class="col-12">
		            <div class="card" id="listadoregistros">
                              <div class="card-header">
                                    <h3 class="card-title">Tramite por Multas y Otras Tasas <!--  <button class="btn btn-info" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Nuevo</button>--> </h3>
                              </div>
			            ...
			            <div class="row">
                              ...
                              <div class="row">
                                    <div class="form-group col-sm-6 col-xs-4">
                                          <label>Monto</label>
                                                <input type="text" name="monto" id="monto" data-name="monto" class="form-control" placeholder="Ingrese Monto">
                                    </div>
                                    <div class="form-group col-sm-6 col-xs-4">
                                          <label>Resolucion</label>
                                                <input type="text" value="N/A" name="resolucion" id="resolucion" class="form-control" placeholder="Ingrese Resolucion ">
                                    </div>
