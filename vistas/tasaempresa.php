                  ...
                  <div class="col-12">
                        <div class="card" id="listadoregistros">
                              <div class="card-header">
                                    <h3 class="card-title">Tasa de Empresas, Comercios e Instituciones</h3>
                              </div>
			            <div class="card-header">
			                  <div class="row">
...
require 'footer.php';
?>
        <script type="text/javascript" src="scripts/tasaempresa.js?ts=<?php echo date("Y-m-d H:i:s");?>"></script>
