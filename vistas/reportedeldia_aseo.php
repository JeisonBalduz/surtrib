                  ...
                  <div class="col-12">
		            <div class="card" id="listadoregistros">
                              <div class="card-header">
                                    <h3 class="card-title"><strong>Reporte del Día Aseo</strong><!--  <button class="btn btn-info" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Nuevo</button>--> </h3>
                                    <a href="reportedeldia_aseo.php" type="submit" class="btn btn-danger float-right">Limpiar</a>
                              </div>
			            ...
			            <div class="card-header">
                              ...
                              <div class="card-body" id="resportedeldia">
                                 <div class="card-header" align="text-center">
                                   ...
                                   <h3 class="card-title" style="text-align: center;"><strong>REPORTE DE OPERACIONES </strong></h3>  
                              </div>                                                 
...
require 'footer.php';
?>
        <script type="text/javascript" src="scripts/reportedeldia_aseo.js?ts=<?php echo date("Y-m-d H:i:s");?>"></script>
