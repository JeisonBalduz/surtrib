                  ...
                  <div class="col-12">
		            <div class="card" id="listadoregistros">
                              <div class="card-header">
                                    <h3 class="card-title">Pagos Taquilla  Aseo<!--  <button class="btn btn-info" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Nuevo</button>--> </h3>
...
require 'footer.php';
?>
        <script type="text/javascript" src="scripts/pagotaquilla_aseo.js?ts=<?php echo date("Y-m-d H:i:s");?>"></script> 
