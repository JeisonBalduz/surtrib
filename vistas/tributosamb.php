			            ...
			            <div class="row">
                                    <div class="form-group col-sm-3 col-xs-12">
                                          <label>Codigo</label>
                                                ...
                                                <input type="text" name="idt" id="idt" class="form-control" placeholder="Ingrese Codigo" >
                                    </div>
                                    
                                    <div class="form-group col-sm-3 col-xs-12">
                                          <label>ITM Min. </label>
                                          <input type="text" name="umtmin" id="umtmin" class="form-control" placeholder="Ingrese ITM Minimo" >
                                    </div>	 
			                  <div class="form-group col-sm-3 col-xs-12">
                                          <label>ITM Max.</label>
                                                <input type="text" name="umtmax" id="umtmax" class="form-control" placeholder="Ingrese ITM Maximo">
                                    </div>
                                    <div class="form-group col-sm-3 col-xs-12">
                                          <label>Partida</label>
                                                 <input type="text" name="partida" id="partida" class="form-control" placeholder="Ingrese Partida">
                                    </div>  
                              </div>
                              <div class="row">
...
require 'footer.php';
?>
        <script type="text/javascript" src="scripts/tributosamb.js?ts=<?php echo date("Y-m-d H:i:s");?>"></script>
