                  ...
                  <div class="col-12">
		            <div class="card" id="listadoregistros">
                              <div class="card-header">
                                    ...
                                    <a href="reportedeldia_taquilla_aseo.php" type="submit" class="btn btn-danger float-right">Limpiar</a>
                              </div>
...
require 'footer.php';
?>
        <script type="text/javascript" src="scripts/reportedeldia_taquilla_aseo.js?ts=<?php echo date("Y-m-d H:i:s");?>"></script>
