                  ...
                  <div class="col-12">
		            <div class="card" id="listadoregistros">
                              <div class="card-header">
                                    <h3 class="card-title">Trámite por otras Tasas <!--  <button class="btn btn-info" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Nuevo</button>--> </h3>
                                    <a href="tasasadministrativas.php" type="submit" class="btn btn-danger float-right">Limpiar</a>
                              </div>
