			            ...
			            <div class="card-header">
			                  <div class="row">
                                          <div class="form-group col-md-4 col-sm-6 col-xs-1">
                                               ...
                                               <select class="form-control input-sm" name="comodinbusqueda" id="comodinbusqueda" placeholder="Buscar" required>
						      ...
						      <div class="form-group col-md-8 col-sm-12 col-xs-1">
						            ...
						            <button type="submit" onclick="tasasadmin()" class="btn btn-info">Mostrar</button>
				                        ...
				                        <a href="tasasadministrativasaseo.php" type="submit" class="btn btn-danger float-right">Limpiar</a>
                                          </div>
				            </div>
					</div> 
...
require 'footer.php';
?>
        <script type="text/javascript" src="scripts/tasasadministrativasaseo.js?ts=<?php echo date("Y-m-d H:i:s");?>"></script>
