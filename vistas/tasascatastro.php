...
<section class="content">
      <div class="container-fluid">
                  ...
                  <div class="col-12">
		            <div class="card" id="listadoregistros">
                              <div class="card-header">
                                    <h3 class="card-title">Tramites por Tasas de Catastro <!--  <button class="btn btn-info" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Nuevo</button>--> </h3>
                              </div>
            ...
            <div class="card card-info" id="formularioregistros">  
                  <div class="card-header">
                        <h3 class="card-title">Formulario de Registro de Tasas de Catastro</h3>
                  </div>
                              ...
                              <div class="row">
                                    <div class="form-group col-sm-10 col-xs-12">
                                          <label>Tasa Administrativa</label>
                                                <select class="form-control" name="vidc" id="vidc" placeholder="Seleccione Categoria">
                                                </select>
                                    </div>
                                    <div class="form-group col-sm-2 col-xs-12">
                                          <label>Unidad</label>
                                                <input type="text" value="1" name="unidad" id="unidad" class="form-control" placeholder="Ingrese cantidad">
                                    </div>
...
require 'footer.php';
?>
        <script type="text/javascript" src="scripts/tasascatastro.js?ts=<?php echo date("Y-m-d H:i:s");?>"></script>
