<?php 
session_start(); 
require_once "../modelos/Modeloingresos_aseo.php";
            ...
            if($cont==0){
            	...
            	if($user_id!=$reg->user_id){
                   $data[$cont]=[
				    ...
				    "5"=>"",
				    "6"=>"",
					"7"=>"<strong style='align:right;'>Total</strong>",
					"8"=>muestrafloat($TotalmontoUser)
	 				];
	 				$TotalmontoUser=0.00;
	 				$cont++;
		 			$data[$cont]=[
                      ...
                      if(($user_id!=$reg->user_id)&&$dia==$reg->dia){//MISMO DIA DIFERENTE CAJERO
		            	  ...
		            	  $Totalmonto+=$reg->monto;
                           ...
                           $data[$cont]=[
						    ...
						    "5"=>"",
						    "6"=>"",
							"7"=>"<strong style='align:right;'>Total Dia</strong>",
							"8"=>muestrafloat($TotalDiamonto)
			 				];
